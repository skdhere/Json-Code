...
<body>
    ...
    <script type="text/javascript">
        ...
        // =================================================================
        // START : Function For getting the Init Code For the Variables
        // =================================================================
            function init_Improper(VarCount)
            {
                var html_data = '';
                    ...
                    html_data += '<table>';
                        html_data += '<tbody>';
                            html_data += '<tr>';
                                ...
                                html_data += '<td>';
                                    html_data += '<div>';
                                        html_data += '<input type="" class="form-control" name="" readonly="">';
                                    html_data += '</div>';
                                    html_data += '<hr>';
                                    html_data += '<div>';
                                        html_data += '<input type="" class="form-control" name="" readonly="">';
            ...
            function init_Operator(param_val, VarCount)
            {
                var html_data = '';
        ...
        // =================================================================
        // END : Function For getting the Init Code For the Variables
        // =================================================================
                            ...
                            if( $('#div_qtype').find('div').length > 1)
                            {
                                ...
                                //{
                                    ...
                                    //{
                                        ...
                                        $('.rmBtn').css('display','none');
                                        createSolutionJson();
                                        var QuestionFormatLength = ar.Question_Format.length;
                                        var VarCount = 1;
                                        var OpCount  = 1;
                                        var init_html_data = '';
                                        for (var i = 0; i < QuestionFormatLength; i++) 
                                        {
                                            var QTypeFormatVarValue = ar.Question_Format[i].Type;
                                            var QTypeFormatEleValue = ar.Question_Format[i].Name;
                                            if(QTypeFormatVarValue == 'variable')
                                            {
                                                // console.log('V'+VarCount);
                                                if(QTypeFormatEleValue == 'enum_mixed_fraction')
                                                {
                                                    init_html_data += init_Mixed(VarCount);
                                                ...
                                                else if(QTypeFormatEleValue == 'enum_improper_fraction')
                                                {
                                                    init_html_data += init_Improper(VarCount);
                                                    init_solu_json = {
                                                        "Name": "enum_improper_fraction",
                                                        "Type": "variable"
                                                    };
                                                }
                                                // ar.Solutions[isSoltion-1].Start.Display.push(init_solu_json);
                                                VarCount++;
                                            }
                                            else if(QTypeFormatVarValue == 'operator')
                                            {
                                                // console.log('O'+OpCount);
                                                if(QTypeFormatEleValue == 'op_multiply')
                                                {
                                                    init_html_data += init_Operator('op_multiply', OpCount);
        ...
        // =================================================================
            ...
            {
                var BB_Format_Validation = '';
                var Display_Part_Validation = '';
                if(stepCount > 1)
                {
                    BB_Format_Validation    = ar.Solutions[isSoltion-1].Steps[stepCount-1].BB_Format.length;
                    Display_Part_Validation = ar.Solutions[isSoltion-1].Steps[stepCount-1].Display.length;
                ...
                {
                    BB_Format_Validation    = 1;
                    Display_Part_Validation = 1;
                }
