...
$param1 = "C:/Python27/python.exe satish-test.py convertMixedToImproperFraction $v1";
$param2 = "C:/Python27/python.exe satish-test.py convertMixedToImproperFraction $v2";
...
$param3 = "C:/Python27/python.exe satish-test.py computeListOfPrimeFactors $result1";
$param4 = "C:/Python27/python.exe satish-test.py computeListOfPrimeFactors $result2";
...
$param5 = "C:/Python27/python.exe satish-test.py cancelCommonFactors $conNUm $conDen";
...
$param6 = "C:/Python27/python.exe satish-test.py multiplyFactors $result5_num";
...
$param8 = "C:/Python27/python.exe satish-test.py convertImproperToMixedFraction $result6 $result7";
